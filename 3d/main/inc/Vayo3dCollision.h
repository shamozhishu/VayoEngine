...
* 碰撞检测
\*************************************************************************/
#ifndef __VAYO3D_COLLISION_H__
#define __VAYO3D_COLLISION_H__
...
class _Vayo3dExport TriContainer
{
public:
...
// 一个简单的三角形容器实现类
class _Vayo3dExport SimpleTriContainer : public TriContainer
{
public:
...
// 碰撞检测器
class _Vayo3dExport CollisionDetector
{
public:
