...
bool GLRenderSystem::init(unsigned char antiAliasFactor /*= 0*/, bool handleSRGB /*= false*/)
{
	...
	if (!setWndPixelFormat((GLWin32Device*)Root::getSingleton().getActiveDevice()))
		return false;
...
{
	if (!RenderSystem::beginScene(backBuffer, zBuffer, stencilBuffer, renderWnd) || !changeRenderContext((GLWin32Device*)renderWnd))
		return false;
...
bool GLRenderSystem::setWndPixelFormat(GLWin32Device* renderWnd)
{
...
bool GLRenderSystem::changeRenderContext(GLWin32Device* renderWnd)
{
...
{
	GLWin32Device* dev = new GLWin32Device(deviceID, attrib);
