...
static GLWin32Device* getDeviceFromHWnd(HWND hWnd)
{
	list<SEnvMapper>::iterator it = g_envMapper.begin();
	for (; it != g_envMapper.end(); ++it)
		if ((*it).hWnd == hWnd)
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	GLWin32Device* dev = getDeviceFromHWnd(hwnd);
	if (dev)
		return dev->windowProc(hwnd, msg, wParam, lParam);
	return DefWindowProc(hwnd, msg, wParam, lParam);
}

LRESULT GLWin32Device::windowProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch (msg)
	{
...
//////////////////////////////////////////////////////////////////////////
GLWin32Device::GLWin32Device(int deviceID, const Attrib& attrib)
...
void* GLWin32Device::getWndHandle() const
{
	return _wndHandle;
}

bool GLWin32Device::handleEvents(bool& idle)
{
	MSG msg = { 0 };
...
void GLWin32Device::sleep(unsigned int milliSeconds, bool pauseTimer)
{
...
void GLWin32Device::setWndCaption(const wstring& wndCaption)
{
...
void GLWin32Device::injectMouseDown(EMouseKeys mouseKey, int x, int y)
{
...
void GLWin32Device::injectMouseUp(EMouseKeys mouseKey, int x, int y)
{
...
void GLWin32Device::injectMouseMove(int x, int y)
{
...
void GLWin32Device::injectMouseWheel(float wheel)
{
...
void GLWin32Device::injectKeyboard(unsigned int keyCode, unsigned int scanCode, bool keyDown)
{
...
void GLWin32Device::injectPaint()
{
	Device::injectPaint();
	PAINTSTRUCT ps;
...
void GLWin32Device::injectDestroy()
{
...
void GLWin32Device::injectActivate()
{
...
void GLWin32Device::injectInactive()
{
...
void GLWin32Device::injectInputLanguageChange()
{
