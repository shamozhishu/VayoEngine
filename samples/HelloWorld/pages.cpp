	...
	: UIDialog(L"modelpage.xml")
{
	...
	m_pCube1 = m_pCurSceneMgr->findObject<Entity>(Language::getSingleton().getLanguageByID(21));
	m_pCube1->setVisible(false);
	m_pCubeBorder1 = m_pCurSceneMgr->findObject<Entity>(Language::getSingleton().getLanguageByID(22));
	m_pCubeBorder1->setVisible(false);
	m_pCube2 = m_pCurSceneMgr->findObject<Entity>(Language::getSingleton().getLanguageByID(23));
	m_pCube2->setVisible(false);
	m_pCubeBorder2 = m_pCurSceneMgr->findObject<Entity>(Language::getSingleton().getLanguageByID(24));
	m_pCubeBorder2->setVisible(false);

	m_pSphere1 = m_pCurSceneMgr->findObject<ManualObject>(Language::getSingleton().getLanguageByID(25));
	m_pSphere1->setVisible(false);
	m_pSphereBorder1 = m_pCurSceneMgr->findObject<ManualObject>(Language::getSingleton().getLanguageByID(26));
	m_pSphereBorder1->setVisible(false);
	m_pSphere2 = m_pCurSceneMgr->findObject<ManualObject>(Language::getSingleton().getLanguageByID(27));
