...
{
public:
	Aabbox3d(): _minEdge(typeUpperLimit<T>(), typeUpperLimit<T>(), typeUpperLimit<T>()),
		_maxEdge(-typeUpperLimit<T>(), -typeUpperLimit<T>(), -typeUpperLimit<T>()) {}
	...
	void setEmpty()
	{
		T maxVal = typeUpperLimit<T>();
		T minVal = -typeUpperLimit<T>();
